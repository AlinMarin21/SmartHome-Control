...
public class Room2Activity extends AppCompat {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        window.setStatusBarColor(ContextCompat.getColor(Room2Activity.this, R.color.green_background));
        window.setNavigationBarColor(ContextCompat.getColor(Room2Activity.this, R.color.green_navigation_background));
        ...
        light_state = BufferManager.TxBuffer[9];
        current_light_color = BufferManager.TxBuffer[45];
        red_rgb_color = BufferManager.TxBuffer[10];
        green_rgb_color = BufferManager.TxBuffer[11];
        blue_rgb_color = BufferManager.TxBuffer[12];
        ...
        Room2Bulb.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                BufferManager.TxBuffer[9] = (byte) light_state;
            }
        });
        ...
        RedButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                BufferManager.TxBuffer[45] = (byte) current_light_color;
                BufferManager.TxBuffer[10] = (byte) red_rgb_color;
                BufferManager.TxBuffer[11] = (byte) green_rgb_color;
                BufferManager.TxBuffer[12] = (byte) blue_rgb_color;
            }
        });
